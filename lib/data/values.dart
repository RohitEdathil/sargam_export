...
const eventNames = [
  ...
  Event('storywriting', 'Story Writing', EventType.solo),
    Event('storywritingenglish', 'Story Writing English', EventType.solo),
  Event('storywritinghindi', 'Story Writing Hindi', EventType.solo),
  Event('storywritingmalayalam', 'Story Writing Malayalam', EventType.solo),
  Event('poemwriting', 'Poem writing', EventType.solo),
  Event('poemwritingenglish', 'Poem writing English', EventType.solo),
  Event('poemwritinghindi', 'Poem writing Hindi', EventType.solo),
  Event('poemwritingmalayalam', 'Poem writing Malayalam', EventType.solo),
